...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Виводимо результат. Додана перевірка для розрахунків
        if (TestCalculations.checkResult(baseOutput, deliveryOutput)){
            getOutput(baseOutput);
            getOutput(deliveryOutput);
            System.out.println("All Done. Good Day!!");
        } else {
            System.out.println("Test fall, wrong calculations");
        }
    }
